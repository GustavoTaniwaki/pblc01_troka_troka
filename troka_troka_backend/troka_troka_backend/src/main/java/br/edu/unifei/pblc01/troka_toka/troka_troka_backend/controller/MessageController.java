...
public class MessageController {
    ...
    @GetMapping("/{user}")
    public Message getMessage(@PathVariable User user) {
        return messageService.getId(user).orElse(null);
    }
    ...
    @PutMapping("/{user}")
    public Message putMessage(@RequestBody Message message, @PathVariable User user) {
